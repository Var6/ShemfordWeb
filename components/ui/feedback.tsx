          ...
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed text-base">
                I am immensely grateful to Shemford Futuristic School, Patna,
                for providing me with an exceptional learning environment that
                helped me achieve the top rank in the 2023-24 academic year. The
                school's focus on holistic development, state-of-the-art
                facilities, and experienced faculty has been instrumental in my
                success. The support and guidance from my teachers have been
                invaluable, encouraging me to strive for excellence and pursue
                my dreams with confidence. Shemford Futuristic School truly
                lives up to its promise of nurturing future leaders.
              </p>
