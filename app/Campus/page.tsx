      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {!loading && (
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
            ...
            {searchTerm && <> for "<span className="text-gray-900 dark:text-white">{searchTerm}</span>"</>}
          </p>
        )}
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="rounded-2xl overflow-hidden animate-pulse">
                ...
                <div className="p-5 space-y-3 bg-white dark:bg-gray-900 border-2 border-orange-100 dark:border-orange-900/30 rounded-b-2xl">
                    ...
                    <CardItem translateZ={20} className="w-full">
                      <div className="relative h-48 overflow-hidden bg-linear-to-br from-orange-100 to-amber-100">
                        {facility.image?.startsWith('http') ? (
                          ...
                          <div className="w-full h-full bg-linear-to-br from-orange-200 to-amber-200" />
                        )}
      ...
      {selectedFacility && (
        ...
        >
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl
            ...
            {/* Body */}
            <div className="overflow-y-auto p-6 space-y-6" style={{ maxHeight: 'calc(90vh - 13rem)' }}>
