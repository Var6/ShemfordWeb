...
import { GraduationCap, Award, Calendar, Briefcase, X, Users, BookOpen, Star, Quote, Clock } from "lucide-react";
...
export default function Faculties() {
  ...
  const subjects = ["All", ...Array.from(new Set(faculties.map(f => f.subject)))];
    ...
    <div className="min-h-screen py-16 px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-7xl mx-auto">
        {filteredFaculties.map((faculty) => {
          const isHovered = hoveredCard === faculty._id;
          ...
          return (
            <div
              ...
              onMouseEnter={() => setHoveredCard(faculty._id)}
            ...
            >
              <div className="relative p-6 flex flex-col items-center text-center space-y-4">
                ...
                <div className="relative w-24 h-24 rounded-full overflow-hidden">
                  {faculty.profileUrl ? (
                    <img src={faculty.profileUrl} alt={faculty.name} />
                  ) : (
                ...
                <div className={`inline-flex px-3 py-1 bg-gradient-to-r ${subjectGradient} text-white text-xs font-semibold rounded-full`}>
                  {faculty.subject}
                </div>
            ...
            <div className="text-center space-y-4">
              <div className="w-32 h-32 mx-auto rounded-full overflow-hidden">
                {selectedFaculty.profileUrl ? (
                  <img src={selectedFaculty.profileUrl} alt={selectedFaculty.name} />
                ) : (
